    ...
    <div class="container">
      <el-tabs v-model="message">
        ...
        <el-tab-pane :label="`未读消息(${unread.length})`" name="first">
          <el-table :data="unread" ref="unread" :show-header="false" style="width: 100%" :reserve-selection="true"  ><!--@selection-change="sels_unread_Change"-->
            ...
            <el-table-column width="120">
              <template slot-scope="scope">
                <el-button type="primary" size="small" @click="handleRead(scope.$index, scope.row)">进货</el-button>
              </template>
            </el-table-column>
          </el-table>
          ...
          <el-dialog title="进货" :visible.sync="add_FormVisible" :close-on-click-modal="false">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="进货原料" prop="title">
                    <el-input :readonly="true" v-model="add_Form.title" >
                    </el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            <div slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click.native="addMaterial" >提交</el-button><!--@click.native="add_FormVisible = false"-->
            </div>
          </el-dialog>
